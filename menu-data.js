  ...
  categories: [
    {
      ...
      label: "🥙 Kebabs",
      items: [
        { name: "Kebab", price: "8€", desc: "Viande grillée, salade, tomates, oignons, sauce au choix", badge: "Best-seller", img: "https://images.unsplash.com/photo-1561651188-d207bbec4ec3?w=400&h=300&fit=crop&q=80" },
        ...
        { name: "Sandwich Galette Steak", price: "9€", desc: "En galette, steak haché maison, crudités, sauce", badge: "Fait maison", img: "https://images.unsplash.com/photo-1550547660-d9450f859349?w=400&h=300&fit=crop&q=80" },
        { name: "Sandwich Galette Filet de Bœuf", price: "9€", desc: "En galette, filet de bœuf, crudités, sauce", badge: "Fait maison", img: "https://images.unsplash.com/photo-1504544750208-dc0358e63f7f?w=400&h=300&fit=crop&q=80" }
      ]
    },
    {
      id: "assiettes",
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Burger Cheddar", price: "9.50€", desc: "Steak haché, cheddar fondu, salade, tomate, sauce", img: "https://images.unsplash.com/photo-1553979459-d2229ba7433b?w=400&h=300&fit=crop&q=80" },
        { name: "Burger Épicée", price: "9.50€", desc: "Steak haché épicé, salade, tomate, sauce piquante", img: "https://images.unsplash.com/photo-1572802419224-296b0aeee0d9?w=400&h=300&fit=crop&q=80" },
    ...
    },
    {
      ...
      label: "🥗 Mezze & Salades",
      items: [
        { name: "Houmous", price: "5€", desc: "Purée de pois chiche, sésame, huile d'olive et ail", img: "https://images.unsplash.com/photo-1637949385162-e416fb15b87b?w=400&h=300&fit=crop&q=80" },
        ...
        { name: "Haydari", price: "5€", desc: "Yaourt, aneth et menthe", img: "https://images.unsplash.com/photo-1563379926898-05f4575a45d8?w=400&h=300&fit=crop&q=80" },
    ...
    },
    {
      ...
      items: [
        ...
        { name: "Nuggets (x6)", price: "5€", desc: "Poulet pané croustillant", img: "https://images.unsplash.com/photo-1619881590738-a111d176d936?w=400&h=300&fit=crop&q=80" },
